...
### Gsym (Blockchain-Node)
   ...
   However, multi-chains operated by 10 byte citizen ID (Decentralized Identifier) and one second block finalization make most of source code make Symverse code wholly different from Ethereum's. For the developers' convenieniences, APIs are almost similar to those of Ethereum.
